...
const envioConfirmacionEmail = async (usuario) => {
    try{
        ...
        transporter.sendMail({
            ...
            subject: 'Confirmación de cuenta', // Asunto
            html: `
            <html>
            <head>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td align="center">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      <tr>
                        <td align="left" bgcolor=" #f7bd00" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                ...
                <tr>
                  <td align="center">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <!-- start copy -->
                      <tr>
                        <td align="left" bgcolor=" #f7bd00" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                          <p style="margin: 0;">Para confirmar tu cuenta, haz click en el siguiente botón. En caso de no haberte registrado en nuestra página, procede a contactarnos.</p>
                        </td>
                      </tr>
                      <!-- end copy -->
                      ...
                      <!-- start button -->
                      <tr>
                        <td align="left" bgcolor=" #f7bd00">
                          <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                              <td align="center" bgcolor=" #f7bd00" style="padding: 12px;">
                ...
                <tr>
                  <td align="center" style="padding: 24px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <!-- start unsubscribe -->
                      <tr>
                        <td align="center" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #f7bd00;">
                          <p style="margin: 0;">© 2023 Pedidos Ágiles</p>
                        </td>
                      </tr>
                      <!-- end unsubscribe -->
...
module.exports = { envioConfirmacionEmail }